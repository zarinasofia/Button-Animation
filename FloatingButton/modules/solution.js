...
frmHome.imgLinkedIn.animate(
			  ...
			  {delay:0,fillMode:kony.anim.FILL_MODE_FORWARDS,duration:0.1},
  ...
  frmHome.imgTwitter.animate(
			  kony.ui.createAnimation({100:{top:"17%","stepConfig":{}}}),
			  {delay:0,fillMode:kony.anim.FILL_MODE_FORWARDS,duration:0.1},
			  {animationEnd: function() {
			  } 
		});
   ...
   frmHome.imgAmazon.animate(
			  kony.ui.createAnimation({100:{top:"34%","stepConfig":{}}}),
			  {delay:0,fillMode:kony.anim.FILL_MODE_FORWARDS,duration:0.1},
			  {animationEnd: function() {
			  } 
		});
   ...
   frmHome.imgFacebook.animate(
			  kony.ui.createAnimation({100:{top:"51%","stepConfig":{}}}),
			  {delay:0,fillMode:kony.anim.FILL_MODE_FORWARDS,duration:0.1},
			  {animationEnd: function() {
			  } 
		});
   ...
   frmHome.imgGoogle.animate(
			  kony.ui.createAnimation({100:{top:"68%","stepConfig":{}}}),
    ...
    frmHome.imgLinkedIn.animate(
			  kony.ui.createAnimation({100:{top:"85%","stepConfig":{}}}),
			  {delay:0,fillMode:kony.anim.FILL_MODE_FORWARDS,duration:0.1},
			  {animationEnd: function() {
			  } 
		});
...
function rotateFlex(){
  ...
  frmHome["imgShare"].animate(
    kony.ui.createAnimation({
        "100": { "stepConfig": { "timingFunction": kony.anim.EASE }, "transform": trans100 }
    }), {
        "delay": 0,
      //  "iterationCount": 1,
  ...
  frmHome["imgShare"].animate(
    kony.ui.createAnimation({
        "100": { "stepConfig": { "timingFunction": kony.anim.EASE }, "transform": trans }
    }), {
        "delay": 0,
      //  "iterationCount": 1,
        "fillMode": kony.anim.FILL_MODE_FORWARDS,
